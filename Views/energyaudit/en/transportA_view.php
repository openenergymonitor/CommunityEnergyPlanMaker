...
<table>
<tr><th width="70px">Cars</th><th width="80px">MPG</th><th width="90px">Fuel</th><th width="200px">Distance travelled</th><th>Work use</th></tr>
<tr>
...
<td><?php echo form_input_text($data,'car1_work',80); ?>&nbsp;%</td>
</tr>
<tr>
...
<td><?php echo form_input_text($data,'car2_work',80); ?>&nbsp;%</td>
</tr>
<tr>
...
<td><?php echo form_input_text($data,'car3_work',80); ?>&nbsp;%</td>
</tr>
...
<td><?php echo form_input_text($data,'ecar_work',80); ?>&nbsp;%</td>
</tr>
